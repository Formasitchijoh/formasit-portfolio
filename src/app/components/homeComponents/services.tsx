...
const ServiceItem = (service: ServiceType) => {
  return (
    <div className="w-full group/link hover:bg-[#D2BEA5] hover:py-5 flex place-content-center gap-5 md:gap-10 my-[5%] h-[25%]">
      ...
      <div className="flex flex-col md:justify-center md:items-start h-[25vh] w-3/4 md:w-1/2">
        <h3 className=" group-hover/link:text-[#1E1917] text-[#D2BEA5] hover:text-[#1E1917] text-[16px] md:text-[36px]">
          {service.title}
        </h3>
